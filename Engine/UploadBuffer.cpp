...
/*
UINT UploadBuffer::CalcConstantBufferByteSize(UINT byteSize)
{
	return (byteSize + 255) & ~255;
}

UploadBuffer::UploadBuffer(ID3D12Device* device, UINT elementCount, bool isConstantBuffer): mIsConstantBuffer(isConstantBuffer)
{
